...
export class Dropdown implements OnInit, AfterContentInit, OnDestroy {
  ...
  @Input() set showSearchFields(v: boolean)        { this.canSearchSignal.set(v !== false); this.searchableSignal.set(v !== false); }
   ...
   */
  useCustomUI = computed(() => this.multipleSelectSignal() || this._extDataSet() || this.searchableSignal());
