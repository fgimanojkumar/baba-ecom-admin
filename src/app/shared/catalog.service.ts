...
export class CatalogService {
  private readonly _categories = signal<CategoryRecord[]>([
    { id: 'CAT001', name: 'Electronics', description: 'Gadgets and devices', gstRate: 18, defaultHsnCode: '8517', taxInclusive: true, status: 'Active', productCount: 150 },
    { id: 'CAT002', name: 'Apparel', description: 'Clothing and fashion', gstRate: 5, defaultHsnCode: '6109', taxInclusive: true, status: 'Active', productCount: 320 },
    { id: 'CAT003', name: 'Home & Kitchen', description: 'Home essentials and kitchenware', gstRate: 18, defaultHsnCode: '7323', taxInclusive: true, status: 'Active', productCount: 96 },
    { id: 'CAT004', name: 'Beauty & Personal Care', description: 'Skincare, haircare and cosmetics', gstRate: 18, defaultHsnCode: '3304', taxInclusive: true, status: 'Active', productCount: 210 },
  ]);
