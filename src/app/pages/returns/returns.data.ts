...
export const MOCK_RETURNS: ReturnRequest[] = [
  {
    ...
    evidence: [{ name: 'size-label.jpg', type: 'image', submittedAt: 'July 16, 2026, 10:15 AM' }],
  },
  {
    ...
    evidence: [{ name: 'damaged-package.jpg', type: 'image', submittedAt: 'July 16, 2026, 11:40 AM' }, { name: 'damage-video.mp4', type: 'video', submittedAt: 'July 16, 2026, 11:42 AM' }],
  },
  {
    ...
    status: 'approved', refundAmount: 1450, evidence: [{ name: 'handbag-condition.jpg', type: 'image', submittedAt: 'July 15, 2026, 9:30 AM' }],
  },
  {
    ...
    status: 'in-transit', refundAmount: 350, trackingId: 'AWB123456789', evidence: [{ name: 'sealed-package.jpg', type: 'image', submittedAt: 'July 14, 2026, 2:15 PM' }],
  },
  {
    ...
    status: 'completed', refundAmount: 1999, trackingId: 'AWB998877665', refundPaymentId: 'PAY005', evidence: [{ name: 'earbuds-defect.mp4', type: 'video', submittedAt: 'July 12, 2026, 1:10 PM' }],
  },
  {
    ...
    status: 'rejected', refundAmount: 380, rejectionReason: 'Return period expired', evidence: [{ name: 'product-photo.jpg', type: 'image', submittedAt: 'July 10, 2026, 4:20 PM' }],
  },
];
