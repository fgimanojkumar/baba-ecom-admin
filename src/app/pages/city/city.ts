...
export class City {
  ...
  readonly form = this.fb.group({
    ...
    deliveryMessage: ['Delivery is temporarily unavailable in this city.'],
  });
  ...
  openAdd(): void {
    ...
    this.form.reset({ stateId: '', name: '', pincode: '', status: 'Active', deliveryMessage: 'Delivery is temporarily unavailable in this city.' });
  }

  openEdit(city: CityRecord): void {
    this.editingId.set(city.id);
    this.form.reset({ stateId: city.stateId, name: city.name, pincode: city.pincode, status: city.status, deliveryMessage: city.deliveryMessage ?? 'Delivery is temporarily unavailable in this city.' });
  }
